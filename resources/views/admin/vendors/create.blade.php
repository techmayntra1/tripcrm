    ...
    <div class="card-body">
        <form action="{{ route('admin.vendors.store') }}" method="POST" class="needs-validation" novalidate>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="Enter vendor/company name" required minlength="2" maxlength="30">
                        @error('name')
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="contact_person" name="contact_person" value="{{ old('contact_person') }}" placeholder="Enter contact person name" maxlength="30">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="mb-3">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('pan_number') is-invalid @enderror" id="pan_number" name="pan_number" value="{{ old('pan_number') }}" placeholder="e.g., ABCDE1234F" maxlength="10" style="text-transform: uppercase;">
                        @error('pan_number')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @else
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" id="opening_balance" name="opening_balance" value="{{ old('opening_balance') }}" placeholder="0" min="0" max="999999999" step="1" inputmode="numeric">
                        </div>
                    </div>
                </div>
            </div>
            <div class="mb-3">
                ...
                <textarea class="form-control" id="address" name="address" rows="3" placeholder="Enter full address" maxlength="150">{{ old('address') }}</textarea>
            </div>
            <hr>
            <h6 class="mb-3"><i class="bi bi-bank me-1"></i> Bank Details (Optional)</h6>
            <div class="row">
                <div class="col-md-4">
                    <div class="mb-3">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('ifsc_code') is-invalid @enderror" id="ifsc_code" name="ifsc_code" value="{{ old('ifsc_code') }}" placeholder="e.g., SBIN0001234" maxlength="11" style="text-transform: uppercase;">
                        @error('ifsc_code')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @else
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="notes" name="notes" maxlength="150">{{ old('notes') }}</textarea>
            </div>
