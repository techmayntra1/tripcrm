    ...
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            <div class="page-title-icon">
                <i class="bi bi-shield-plus icon-gradient bg-happy-itmeo"></i>
            </div>
            <div>
                Add New Role
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('description') is-invalid @enderror" id="description" name="description" value="{{ old('description') }}" placeholder="Enter role description">
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                @foreach($actions as $actionKey => $action)
                                    ...
                                    <label class="permission-btn {{ $action['color'] }}" title="{{ $action['name'] }}">
                                        <input type="checkbox" name="permissions[]" value="{{ $permission->id }}" class="permission-checkbox" data-module="{{ $moduleKey }}" {{ in_array($permission->id, old('permissions', [])) ? 'checked' : '' }}>
