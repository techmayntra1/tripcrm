...
<form action="{{ route('admin.projects.store') }}" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate id="projectForm">
    @csrf
    <div class="main-card mb-3 card">
        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                <label for="project_files" class="form-label">Trip Files</label>
        ...
        <div class="col-md-6">
            <div class="main-card mb-3 card">
                ...
                <div class="card-body">
                    ...
                    @include('admin.projects._gst_section', ['gstRates' => $gstRates, 'project' => null])
                </div>
            </div>
        </div>
    </div>

    @include('admin.projects._services_section', ['existingServices' => collect(), 'services' => $services, 'banks' => $banks])
