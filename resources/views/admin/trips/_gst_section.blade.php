@php
    $gstPercentVal = old('gst_percent', $trip->gst_percent ?? 0);
    $gstInclusiveVal = old('gst_inclusive', $trip->gst_inclusive ?? false);
    $gstSplitVal = old('gst_split', $trip->gst_split ?? false);
@endphp
<div id="tripGstSection" class="mb-0" style="display: none;">
    <hr class="my-2">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const section = document.getElementById('tripGstSection');
