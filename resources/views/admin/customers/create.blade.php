                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <input type="number" class="form-control @error('budget') is-invalid @enderror" id="budget" name="budget" value="{{ old('budget') }}" placeholder="Enter budget" min="0">
                            @error('budget')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select select2-multiple @error('project_ids') is-invalid @enderror" id="project_ids" name="project_ids[]" multiple>
                            @foreach($projects as $project)
                                <option value="{{ $project->id }}" {{ in_array($project->id, old('project_ids', [])) ? 'selected' : '' }}>{{ $project->project_number }} - {{ $project->name }}</option>
                            @endforeach
                        </select>
                        @error('project_ids')
                            <div class="invalid-feedback">{{ $message }}</div>
