    ...
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            <div class="page-title-icon">
                <i class="bi bi-person-plus-fill icon-gradient bg-deep-blue"></i>
            </div>
            <div>Add Staff</div>
        </div>
...
<form action="{{ route('admin.staff.store') }}" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-lg-8">
            <div class="main-card mb-3 card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('joining_date') is-invalid @enderror" id="joining_date" name="joining_date" value="{{ old('joining_date', date('Y-m-d')) }}" required>
                                @error('joining_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @else
                    ...
                    <div class="mb-0">
                        ...
                        <textarea class="form-control" id="address" name="address" rows="2" placeholder="Enter full address" maxlength="150">{{ old('address') }}</textarea>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-0">
                                ...
                                <div class="input-group has-validation">
                                    ...
                                    <input type="number" class="form-control @error('salary_amount') is-invalid @enderror" id="salary_amount" name="salary_amount" value="{{ old('salary_amount') }}" placeholder="Enter salary" min="1" max="999999999" step="1" required inputmode="numeric">
            ...
            <div class="main-card mb-3 card">
                <div class="card-header">
                    <i class="bi bi-bank me-2"></i> Bank Details <span class="text-muted fw-normal">(Optional)</span>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="bank_name" name="bank_name" value="{{ old('bank_name') }}" placeholder="Enter bank name" maxlength="100">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="account_number" class="form-label">Account Number</label>
                                <input type="text" class="form-control" id="account_number" name="account_number" value="{{ old('account_number') }}" placeholder="Enter account number" maxlength="20">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-0">
                                <label for="ifsc_code" class="form-label">IFSC Code</label>
                                <input type="text" class="form-control" id="ifsc_code" name="ifsc_code" value="{{ old('ifsc_code') }}" placeholder="e.g., SBIN0001234" maxlength="11" style="text-transform: uppercase;">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        @error('pan_card')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <div id="pan_card_preview" class="mt-2" style="display: none;">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="aadhar_side_select">
                            <option value="">Select Side to Upload</option>
                    ...
                    <div id="aadhar_front_section" style="display: none;">
                        <div class="mb-3">
                            <label for="aadhar_front" class="form-label">Aadhar Front <span class="text-danger">*</span></label>
                            <input type="file" class="form-control @error('aadhar_front') is-invalid @enderror" id="aadhar_front" name="aadhar_front" accept="image/jpeg,image/png,image/jpg">
                            <small class="text-muted">JPG, JPEG, PNG (Max 2MB)</small>
                            @error('aadhar_front')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div id="aadhar_front_preview" class="mt-2" style="display: none;">
                                <img src="" alt="Aadhar Front Preview" class="img-thumbnail" style="max-height: 120px;">
                                <span class="badge bg-success ms-2">Front Uploaded</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="aadhar_back_section" style="display: none;">
                        <div class="mb-3">
                            <label for="aadhar_back" class="form-label">Aadhar Back <span class="text-danger">*</span></label>
                            <input type="file" class="form-control @error('aadhar_back') is-invalid @enderror" id="aadhar_back" name="aadhar_back" accept="image/jpeg,image/png,image/jpg">
                            <small class="text-muted">JPG, JPEG, PNG (Max 2MB)</small>
                            @error('aadhar_back')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div id="aadhar_back_preview" class="mt-2" style="display: none;">
                                <img src="" alt="Aadhar Back Preview" class="img-thumbnail" style="max-height: 120px;">
                                <span class="badge bg-success ms-2">Back Uploaded</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="aadhar_status" class="mt-3">
                        <div class="d-flex gap-2">
                            <span id="front_status" class="badge bg-secondary">Front: Not uploaded</span>
                            <span id="back_status" class="badge bg-secondary">Back: Not uploaded</span>
                        </div>
                    </div>
                </div>
            </div>
...
$(document).ready(function() {
    var aadharFrontUploaded = false;
    var aadharBackUploaded = false;
